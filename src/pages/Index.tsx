...
AI가 깔끔한 특허 요약서를 생성해 드립니다.<br className="hidden sm:block" />
          ...
          animationDelay: "0.3s"
            ...
            <section className="mb-8">
              <PatentSummary content={summary} patentNumber={currentPatent} isStreaming={isLoading} patentData={patentData} />
            </section>
