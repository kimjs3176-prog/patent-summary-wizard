...
const DOMAIN_PHRASES: string[] = [
  ...
  // 항암·바이오의약 (천연물 신약 트랙)
  "항암 효능", "항암 효과", "항암 활성 성분", "암세포 사멸", "세포 사멸 유도",
  "종양 억제", "종양 성장 억제", "암 전이 억제", "전이 억제", "혈관신생 억제",
  "면역 항암", "면역 활성화", "선택적 독성", "정상 세포 보호",
  "천연물 유래", "식물 추가물 유래", "식물 유래", "귀리 추출물", "추출물 기반",
  "유효 성분 표준화", "지표 성분", "표준화 추출물",
  // 전임상·임상 단계
  "전임상 시험", "전임상 단계", "동물 효능 시험", "독성 시험", "안전성 평가",
  "약효 평가", "약동학 분석", "임상 시험", "임상 1상", "임상 2상", "임상 3상",
  "IND 신청", "GLP 시험", "GMP 생산",
  // 규제·인허가
  "식약처 허가", "식약처 인증", "건강기능식품 인증", "기능성 원료 인정",
  "개별인정형 원료", "GRAS 인증",
  // R&D 지원·사업화
  "국가 R&D 과제", "정부 R&D 지원", "범부처 신약 개발", "오픈이노베이션",
  "기술이전 계약", "라이선스 아웃", "공동 연구", "산학 협력",
  // 시장 분류
  "건강기능식품", "기능성 식품", "천연물 신약", "바이오 신약", "신약 후보 물질",
  "후보 물질 도출", "파이프라인 확보",
  // 산업·시장
...
const COMPOUND_TAIL_NOUNS = [
  ...
  "핵심", "원천", "독자", "신규", "혁신", "최적화",
  "효능", "활성", "독성", "안전성", "유효성", "후보", "물질", "추출물",
  "시험", "단계", "평가", "인증", "허가", "지원", "과제", "계약",
  "신약", "치료제", "백신", "키트", "진단", "예방", "억제", "사멸",
];
