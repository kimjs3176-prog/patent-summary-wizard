...
## 시장동향
국내 관련 시장의 현재 규모(원화 기준)와 성장 추세를 먼저 분석하고, 글로벌 시장 규모 및 성장률도 함께 제시하세요. 주요 경쟁 기술 및 대체 기술 동향, 해당 기술 분야의 정책·규제 환경 변화를 2~3문장으로 분석하세요.
...
## 시장동향
국내 관련 시장의 현재 규모(원화 기준)와 성장 추세를 먼저 분석하고, 글로벌 시장 규모 및 성장률도 함께 제시하세요. 주요 경쟁 기술 및 대체 기술 동향, 해당 기술 분야의 정책·규제 환경 변화, 글로벌 시장 진출 가능성을 상세히 분석하세요.
