...
## 주요 청구항 분석
${patentData?.claims && patentData.claims.length > 0 ? `제공된 ${patentData.claims.length}개의 청구항을 분석하여 핵심 기술 범위와 보호 대상을 설명합니다. 청구항 원문 내용을 바탕으로 특허의 권리 범위를 명확히 기술합니다.` : "제공된 데이터에 청구항 정보가 없어 분석 불가합니다."}
