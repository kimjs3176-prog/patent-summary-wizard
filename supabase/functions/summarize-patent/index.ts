...
## 특허 기본 정보
등록번호는 ${patentData?.patentNumber || patentNumber}입니다.
발명의 명칭은 ${patentData?.title || "정보 없음"}입니다.
출원인/권리자는 ${patentData?.assignee || "정보 없음"}입니다.
출원일/등록일은 ${patentData?.filingDate || "정보 없음"} / ${patentData?.publicationDate || "정보 없음"}입니다.
발명자는 ${patentData?.inventors?.join(", ") || "정보 없음"}입니다.
