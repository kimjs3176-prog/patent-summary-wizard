...
- **[금지 - 절대 볼드하지 말 것]**
  ...
  · **동사·서술 어구는 절대 볼드 금지**: "확보", "구성", "수립", "향상", "절감", "활용", "급여", "분석", "측정", "추정", "해결" 같은 동작·서술 표현. 잘못된 예: **단계에서 확보**, **이를 해결**, **세트를 구성**, **방식을 채택**, **시스템을 구축**.
  · **지시·시점 어구 시작 금지**: "현재 본 기술", "종합하면 본 기술", "최근 본 발명", "본 기술은", "본 발명은" 등 — 가치 정보가 0이다.
  · **"... 기술/발명/방식/시스템/구조"로 끝나는 명사구는 그 뒤 일반명사를 볼드에 포함하지 말 것**. 잘못된 예: **유전체 분석 기술**, **고부가가치 바이오 진단 기술** → 올바른 형태: **유전체 분석**, **고부가가치 바이오 진단**.
  · **격조사·어절 경계 위반 금지**: 볼드 안에 "에서/으로/에게/와의/을/를" 같은 격조사가 포함된 절 단위 강조 금지. 잘못된 예: **단계에서 확보**, **세트를 구성**, **키트를 활용**.
- **볼드 핵심 원칙**: 볼드는 명사(또는 형용사+명사)로 시작해 명사로 끝나는 **단일 명사구**여야 하며, 동사·격조사·문장부호를 포함하지 않는다.
