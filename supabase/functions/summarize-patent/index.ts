...
- 올바른 예: **바이오매스**를, **발효당**으로, 약 **1,700억 달러** 규모, **CAGR**은 15%, **신규 펩타이드 프로테티아마이신 2**(서열번호 1), **그람 양성균**, **C07K 7/08**
- 잘못된 예: **바이오매스를**, **발효당으로**, **약 1,700억 달러 규모에서**, **CAGR은**
- 조사(을/를/이/가/은/는/의/에/로/으로/와/과 등)와 어미·접속사는 반드시 볼드 바깥에 위치
- **[밀도 - 필수 준수]** 한 문장당 **2~5곳**, 한 문단당 **6~12곳**을 볼드 처리하여 정보 밀도 높은 보고서 스타일을 구현한다(첨부 예시 수준). 문단 전체에 볼드가 0~1개만 있으면 불충분 — 반드시 보강한다.
- 볼드 대상(모두 적극 강조):
  ① **구체적 수치·지표**: 수율, 농도, CAGR, 시장규모, 효율 향상 배수 등(단위·기호 포함 가능)
  ② **고유명사·화학명·균주명·서열·코드**: 화합물명, 펩타이드명, 학명 대응 한글명, IPC 분류 코드(예: **C07K 7/08**, **A61K 38/10**), 서열번호, 균주번호
  ③ **핵심 소재·원료·공급원**: 원료 식물·곤충·미생물, 신규 물질, 핵심 성분
  ④ **기능·효능·작용을 나타내는 명사·명사구**: **항균**, **항진균**, **항균 활성**, **세포 독성**, **생체이용률 향상**, **저독성**, **천연 유래**, **친환경**, **지속 가능** 등
  ⑤ **적용·활용 분야**: **식품 방부제**, **화장품 보존제**, **의약품**, **피부 외용제**, **스마트팜**, **정밀농업**, **천연 농약**, **친환경 식물보호제**, **사료 첨가제**, **장염 치료제** 등
  ⑥ **차별점·전략 키워드**: **신규**, **세계 최초**, **기존 한계 극복**, **저비용**, **고효율**, **상용화**, **임상**, **전임상**, **규제 승인** 등
  ⑦ **시장·산업·정책 핵심어**: 산업 분야명, 정책·인증명, 표준명
- **[금지] 무의미한 단어 단독 볼드 금지**: "기술", "발명", "방법", "공정", "본 기술", "해당 기술", "이러한 기술", "따라서 해당 기술", "특징", "효과" 등 일반 명사 단독·지시어 결합형은 볼드 금지(단, **구체 수식어 + 일반 명사** 결합은 허용: 예 **신규 펩타이드**, **친환경 농약**).
- 볼드 구절 길이: 1~6 어절(약 2~25자) 범위 내에서 자연스러운 명사구 단위로 끊는다. 절·문장 단위 볼드 금지.
